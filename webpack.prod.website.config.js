...
configWebsite.externals = _.assign(configWebsite.externals, utilities.mapArrayOfObjectPropToProp(require('./webpack-config/external-libraries.conf').website, 'name', 'importName'));
