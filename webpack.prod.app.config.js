...
configApp.externals = _.assign(configApp.externals, utilities.mapArrayOfObjectPropToProp(require('./webpack-config/external-libraries.conf').app, 'name', 'importName'));
